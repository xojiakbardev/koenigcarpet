...
export const RugDetails: FC<Props> = ({ rug, locale }) => {
  ...
  }, [basePrice, rug.sizes, searchParams]);
    ...
    <div className="flex flex-col gap-4 pb-4 mb-4 border-b">
      ...
      {hasFeatures && (
        ...
        >
          ...
          <div id="features-content" className="min-h-0 overflow-hidden">
            <div className="text-sm py-2">
              {features?.head && <p className="mb-4">{features.head}</p>}

              {features?.care_and_warranty &&
                features.care_and_warranty.length > 0 && (
                  <div className="mb-4">
              ...
              {features?.technical_info &&
                features.technical_info.length > 0 && (
                  <div>
                    <h3 className="mb-2 uppercase font-semibold text-sm">
